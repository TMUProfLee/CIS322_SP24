...
class GameSetup():
    ...
    def FugitiveFirst(self):
        ...
        for i in self.fugitive.deck:
          self.fugitive_hand.append(i)
          print(i.value)
    ...
    def start_game(self):
        ...
        Player1, Player2, Player1Role, Player2Role = self.character_selection()
        if Player1Role == "fugitive":
            self.fugitive_name = Player1
            self.marshall_name = Player2
        else:
            self.fugitive_name = Player2
            self.marshall_name = Player1
        first_turn = True
